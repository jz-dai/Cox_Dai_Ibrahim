...
kable(summary(microplastics$Sampling.Method),
  caption = "Table 1. Occurrences of Various Sampling Methods within Global Dataset",
...
Table: Table 2. Generalized Linear Model Analysis

Analysis  | P-Value
:-------------: | :-------------:
Linear Regression  | 1.284e-05

Table: Table 3. AIC Analysis, formula = Measurement ~ Year + Month + Latitude + Longitude
